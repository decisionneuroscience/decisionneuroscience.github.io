...
- **Behavioral Decision Science**: Risk preference, temporal discounting, prosocial behavior in consumption and healthcare contexts
- **Computational Modeling**: Drift Diffusion Models (DDM), Reinforcement Learning, multi-modal data integration (RT, Eye-tracking, EEG, fMRI)
- **Consumer Neuroscience**: Neural mechanisms underlying consumer behavior and social decision-making
- **AI & Neuroscience Integration**: Deep learning, large language models combined with cognitive neuroscience tools
...
We are committed to transparency in research. You can find our pre-registrations and open data on our **[OSF Project Page](https://osf.io/3e4zy/)**.
...
**发明专利**
- 面向全流程的行为实验数据采集平台 (2024)
- 一种基于眼动轨迹追踪的广告智能评估方法与系统 (2021)

**软件著作权**
- 基于眼动追踪技术的广告评估平台 v1.0 (2021)
...
| 设备 | 规格 | 应用 |
|------|------|------|
| **MRI** | 3T Siemens 研究专用磁共振 | fMRI, 结构成像, DTI |
| **EEG** | 高密度脑电记录系统 | ERP, 时频分析, 脑网络 |

### 👁️ 行为追踪 | Behavioral Tracking
...
| 设备 | 规格 | 应用 |
|------|------|------|
| **TMS** | 经颅磁刺激系统 | 因果推断, 脑功能调控 |
| **tDCS** | 经颅直流电刺激系统 | 认知增强研究 |

### 💻 软件平台 | Software

- **自主研发**: 面向全流程的行为实验数据采集平台
- **计算建模**: DDM, Reinforcement Learning, Bayesian Estimation
- **数据分析**: Python, R, MATLAB, SPM, EEGLAB

---

> 💻 **GitHub**: [https://github.com/decisionneuroscience](https://github.com/decisionneuroscience)
